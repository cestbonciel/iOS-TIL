...
class ViewController: UIViewController {
	...
	private var apiKey: String {
		get {
			...
			guard let value = plist?.object(forKey: "openWeatherMapKey") as? String else {
				fatalError("Couldn't find key 'OPENWEATHER MAP KEY' in 'KeyList.plist'")
			}
			return value
		}
	}
